////
////  Confetti-Emitter+Factory.swift
////  SharedConfetti
////
...
//
//extension Confetti {
//    func makeLeftCannon(with images: [UIImage]) -> CAEmitterLayer {
...
//        emitter.emitterCells = makeCells(with: images)
//        return emitter
//    }
//    
//    func makeCells(with images: [UIImage]) -> [CAEmitterCell] {
//        return images.map { image in
////            makeCell(with: image)
//        }
//    }
//    
//    func makeCell(with image: UIImage) -> CAEmitterCell {
