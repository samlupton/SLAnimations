...
extension Plume.Cell.Spin {
    ...
    public static let subtle = Plume.Cell.Spin(base: 0.2, range: 0.1)

    /// Gentle, natural rotation.
    public static let gentle = Plume.Cell.Spin(base: 0.8, range: 0.3)

    // MARK: - Standard Motion

    /// Balanced default rotation for most effects.
    public static let normal = Plume.Cell.Spin(base: 1.5, range: 0.6)

    // MARK: - Energetic Motion

    /// Noticeable, expressive spin.
    public static let lively = Plume.Cell.Spin(base: 3.0, range: 1.0)

    /// Fast, high-energy rotation.
    public static let fast = Plume.Cell.Spin(base: 5.0, range: 2.0)
